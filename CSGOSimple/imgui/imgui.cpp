...
/*
 ...
 EXHIBIT 2: IMPLEMENTING CUSTOM BINDING / CUSTOM ENGINE.
     ...
     // (In the examples/ app this is usu
     done within the ImGui_ImplXXX_Init() function from one of the demo Renderer)
     int width, height;
 ...
 A: Use the font atlas to load the TTF/OTF file you want:
    ...
    Default is CONSOLA.ttf, monospace, rendered at size 13, embedded in dear imgui's source code.
