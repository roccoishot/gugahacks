...
public:
	dlight_t* CL_AllocDlight(int key)
	{
		...
		return CallVFunction<Fn>(this, 4)(this, key);
	}
	dlight_t* CL_AllocElight(int key)
	{
		typedef dlight_t* (__thiscall* Fn)(PVOID, int);
		return CallVFunction<Fn>(this, 5)(this, key);
	}
	dlight_t* GetElightByKey(int key)
	{
		typedef dlight_t* (__thiscall* Fn)(PVOID, int);
		return CallVFunction<Fn>(this, 8)(this, key);
	}
};

class LWNetChannelInfo {
public:
