...
void Options::SetupVisuals()
{
	...
	SetupValue(night2, "Visuals", "Night");
	SetupValue(baggage, "Visuals", "Baggage");
	SetupValue(tibet, "Visuals", "Tibet");
	SetupValue(vietnam, "Visuals", "Vietnam");
	SetupValue(sky_lunacy, "Visuals", "Lunacy");
	SetupValue(italy, "Visuals", "Italy");
	SetupValue(jungle, "Visuals", "Jungle");
	SetupValue(office, "Visuals", "Office");
...
void Options::SetupMisc()
{
	...
	SetupValue(hitmetallic, "Misc", "Metallic");
	SetupValue(hitchicken, "Misc", "Chicken");
	SetupValue(hitspark, "Misc", "Spark");
	SetupValue(hitfranz, "Misc", "FranzJ");
	SetupValue(hitfail, "Misc", "FAIL!");
	SetupValue(hitbeep, "Misc", "Beep");
	SetupValue(hithurt, "Misc", "Hurt");
	SetupValue(hitsnap, "Misc", "Snap");
